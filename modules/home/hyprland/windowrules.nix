{
  ...
  inherit
    (import ../../../hosts/${host}/variables.nix { inherit inputs; })
...
in {
  wayland.windowManager.hyprland = {
    settings = {
      windowrule = [
        #"no_blur on, match:xwayland 1" # Helps prevent odd borders/shadows for xwayland apps
        ...
        "tag +terminal, match:class ^(com.mitchellh.ghostty|org.wezfurlong.wezterm|Alacritty|foot|foot-dropterm)$"
